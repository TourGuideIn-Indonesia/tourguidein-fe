...
export default function Checkout() {
  ...
  const handleSendMessage = async () => {
    try {
      const response = await axiosPrivate.post("/api/booking", {
        ...
        starting_location: bookingData.startingLocation ?? "Meeting Point",
        ending_location: bookingData.endingLocation ?? "City Center",
        promo_code: null,
      });
